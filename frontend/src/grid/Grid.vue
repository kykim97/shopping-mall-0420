<template>
    <div class="container-fluid">
        ...
        >
            <wj-flex-grid-filter :filterColumns="['Id','ProductId','Qty','CustomerId','Status',]" />

            <wj-flex-grid-column binding="Id" header="Id" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="ProductId" header="ProductId" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="Qty" header="Qty" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="CustomerId" header="CustomerId" width="2*" :isReadOnly="true" />
            <wj-flex-grid-column binding="Status" header="Status" width="2*" :isReadOnly="true" />
        </wj-flex-grid>
    </div>
</template>
        ...
        getData: function() {
            ...
            for (let i = 0; i < countries.length; i++) {
                data.push({
                    ...
                    Qty: countries[i].qty,
                    CustomerId: countries[i].customerId,
